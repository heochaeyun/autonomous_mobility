...
if __name__ == "__main__":
    ...
    plot_trajectory("/Volumes/autonomous_mobility/dataset/poses/04.txt")

    process_images("/Volumes/autonomous_mobility/dataset/sequences/08/image_0", "left_frames")
    process_images("/Volumes/autonomous_mobility/dataset/sequences/08/image_1", "right_frames")
